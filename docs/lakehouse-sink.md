   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-hudi-4.0.0.2.nar",
   ...
   ```json
    {
        ...
        "archive": "connectors/pulsar-io-hudi-4.0.0.2-cloud.nar",
        "parallelism": 1,
        "processingGuarantees": "EFFECTIVELY_ONCE",
        "configs":   {
            "type": "hudi",
...
1. Copy the NAR package to the Pulsar connectors directory.
    ...
    ```
    cp pulsar-io-lakehouse-4.0.0.2.nar PULSAR_HOME/connectors/pulsar-io-lakehouse-4.0.0.2.nar
    ```
